...
    docker run -it ttldtor/splunk:universalforwarder:latest
    docker run --env SPLUNK_START_ARGS="--accept-license --answer-yes --seed-passwd changeme" ttldtor/splunk:universalforwarder:latest
