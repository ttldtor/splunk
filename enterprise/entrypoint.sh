...
    docker run -it ttldtor/splunk:enterprise:latest
    docker run --env SPLUNK_START_ARGS="--accept-license --answer-yes --seed-passwd changeme" ttldtor/splunk:enterprise:latest
